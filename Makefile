...
VSAG_CMAKE_ARGS := ${VSAG_CMAKE_ARGS} -DVSAG_USE_PREBUILT_DEPS=${VSAG_USE_PREBUILT_DEPS}
ifneq ($(strip ${VSAG_PREBUILT_DEPS_DIR}),)
  VSAG_CMAKE_ARGS := ${VSAG_CMAKE_ARGS} -DVSAG_PREBUILT_DEPS_DIR=${VSAG_PREBUILT_DEPS_DIR}
endif
