...
vsag_resolve_prebuilt (antlr4 4.13.2 MD5=3b75610fc8a827119258cba09a068be5
                      "${FULL_CXX_FLAGS}" install_dir antlr4_prebuilt)
...
set (antlr4_generated_include ${CMAKE_CURRENT_BINARY_DIR}/antlr4/generated/include)
target_include_directories (vsag_antlr4_autogen_headers SYSTEM INTERFACE
    ${antlr4_generated_include}
    ${antlr4_generated_include}/antlr4-autogen)
...
file (COPY extern/antlr4/fc/
      DESTINATION ${antlr4_generated_include}/antlr4-autogen
      FILES_MATCHING
      PATTERN "*.h"
      PATTERN "*.hpp")
